    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-POSTapi-guests">Создает нового гостя.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-guests--id-">
                                <a href="#endpoints-GETapi-guests--id-">Получает информацию о госте или список всех гостей.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-guests">
                                <a href="#endpoints-GETapi-guests">Получает информацию о госте или список всех гостей.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PUTapi-guests--id-">
                                <a href="#endpoints-PUTapi-guests--id-">Обновляет данные гостя.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-DELETEapi-guests--id-">
                                <a href="#endpoints-DELETEapi-guests--id-">Удаляет гостя.</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<p>This API is not authenticated.</p>
        ...
        <h1 id="endpoints">Endpoints</h1>
                                ...
                                <h2 id="endpoints-POSTapi-guests">Создает нового гостя.</h2>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Имя гостя. Example: <code>Петр</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Фамилия гостя. Example: <code>Петров</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Email гостя. Example: <code>petr@test.ru</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Телефон гостя. Example: <code>+79991112233</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>Страна проживания гостя. Example: <code>Россия</code></p>
        </div>
        </form>

                    <h2 id="endpoints-GETapi-guests--id-">Получает информацию о госте или список всех гостей.</h2>
...
<form id="form-GETapi-guests--id-" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-guests--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-guests--id-"
                    onclick="cancelTryOut('GETapi-guests--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<p>The ID of the guest. Example: <code>1</code></p>
                    ...
                    <h2 id="endpoints-GETapi-guests">Получает информацию о госте или список всех гостей.</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-PUTapi-guests--id-">Обновляет данные гостя.</h2>
...
<p>Страна проживания гостя. Example: <code>Россия</code></p>
                    ...
                    <h2 id="endpoints-DELETEapi-guests--id-">Удаляет гостя.</h2>
